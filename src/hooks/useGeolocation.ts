...
/**
 * Custom hook to get the user's geolocation with basic city/country approximation.
 * Caches the result in localStorage for faster subsequent loads.
 */
  ...
  const requestLocation = () => {
    ...
    navigator.geolocation.getCurrentPosition(
      async (position) => {
        ...
        try {
          // Use approximate city/country logic (replace with real geocoding in production)
...
// Note: For production, consider using a proper geocoding API like Google Maps, OpenCage, etc.
// This example uses simple logic for demonstration purposes only.
